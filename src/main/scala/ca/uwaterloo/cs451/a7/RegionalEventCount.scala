...
object RegionEventCount {
  ...
  def main(argv: Array[String]): Unit = {
    ...
    val goldman = List((-74.0141012, 40.7152191), (-74.013777, 40.715227), (-74.0141027, 40.7138745), (-74.0144185, 40.7140753))
    ...
    val wc = stream.map(_.split(","))
      .map(l => {
        ...
        (List(l(8).toDouble, l(9).toDouble))}
      else {
      (List(l(10).toDouble, l(11).toDouble)) }
      (taxi_type, 1)
      //Citigroup
      })
      ...
      .map(p => {
        if ((p._1(0).toDouble > -74.012083 && p._1(0).toDouble < -74.009867)  && (p._1(1).toDouble > 40.720053 && p._1(1).toDouble < 40.7217236 ))
